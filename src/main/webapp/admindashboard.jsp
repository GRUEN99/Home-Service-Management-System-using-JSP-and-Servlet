...
<body>
    <div class="navbar">
        ...
        <a href="displayclientservlet">Display Client Details <br> Update/Delete Client Details </a> 
        <!--  <a href="updateDeleteClient.jsp">Update/Delete Client Details</a> -->
        <a href="display.jsp">Display services</a>
        <a href="clientdel.jsp">Delete client details</a>
        </div>
